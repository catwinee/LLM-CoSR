...
from src.utils.lightgcl_utils import sparse_dropout, spmm
import torch.nn.functional as F

class LightGCL_Net(nn.Module):
    def __init__(self, n_u, n_i, d, u_mul_s, v_mul_s, ut, vt, train_csr, adj_norm, l, temp, lambda_1, lambda_2, dropout, device):
        super(LightGCL_Net,self).__init__()
        ...
        self.u_mul_s = u_mul_s.cuda()
        self.v_mul_s = v_mul_s.cuda()
        self.ut = ut.cuda()
        self.vt = vt.cuda()
